-- Re-apply upsert-from-generated_rows after 20260507120000 (update-only RPC).
-- Ensures first checkbox write succeeds when list.generated_rows exists but
-- list.row_overrides has no row yet, without falling back to full save_shopping_state.
