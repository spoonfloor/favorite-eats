-- List-only save_shopping_state must not bump plan.documents.updated_at.
-- That timestamp drives plan Realtime, which re-ran heal/merge full-doc list saves
-- and caused autonomous save_shopping_state feedback loops (see list-noise HAR).
